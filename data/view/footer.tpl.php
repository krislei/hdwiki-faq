...
<footer id="footer" class="footer">
    <div class="wrap clearfix">
        <p id="footer-p" class="copyright"> Copyright @ <a href="http://www.comsys.net.cn" target="_blank">成都康赛信息技术有限公司</a> WIKI V6.0&copy;1998-2017 <a href="#" target="_blank" class="link_black">知识库</a> |
            <a
                href="#">了解我们</a> <br/>
